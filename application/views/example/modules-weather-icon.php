                ...
                <div class="col-sm-12 icon-set">
                  ...
                  <div class="alert alert-primary alert-has-icon">
                    ...
                    <div class="alert-body">
                      ...
                      <p></p>
                      <p>
                        To make a wind icon appear, you need to add 3 classes, the base icon class, the wind icon class, and then the direction you want it to face: <code>class="wi wi-wind towards-23-deg"</code>
                      </p>

                      <p></p>
                      <p>
                        NOTE: You must include the additional stylesheeet, <code>weather-icons-wind.css</code> to use the wind icons and API mappings.
                      </p>
                    </div>
                  </div>
                  <div class="row">
                ...
                <div class="col-sm-12 icon-set">
                  ...
                  <div class="alert alert-primary alert-has-icon">
                    ...
                    <div class="alert-body">
                      ...
                      <p></p>
                      <p>
                        To make a wind icon appear, you need to add 3 classes, the base icon class, the wind icon class, and then the direction you want it to face: <code>class="wi wi-wind wi-from-e"</code>
                      </p>
                      <p>
                        NOTE: You must include the additional stylesheeet, <code>weather-icons-wind.css</code> to use the wind icons and API mappings.
                      </p>
